...
public class ItemAdapter extends BaseAdapter {
    ...
    public ItemAdapter(Context context, List<Pet> pets) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setImageResource(pet.getImageId());
        nameTextView.setText(pet.getPetNameId());
        breedTextView.setText(pet.getPetBreedId());
