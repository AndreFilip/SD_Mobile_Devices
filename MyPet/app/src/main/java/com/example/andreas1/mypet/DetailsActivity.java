...
public class DetailsActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_KEY_FOR_INDEX = "extra_key_for_index";
    private static final String KEY_FOR_INDEX = "key_for_index";
    public static final String EXTRA_KEY_FOR_CATEGORY = "extra_key_for_category";
